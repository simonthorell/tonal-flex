...
echo -e "${BOLD_GREEN}Starting Elk SUSHI macOS ARM64 download & install script...${RESET}\n"
...
SUSHI_VERSION="1.1.0"
SUSHI_URL="https://github.com/elk-audio/sushi/releases/download/${SUSHI_VERSION}/sushi-macos-arm64_${SUSHI_VERSION}.zip"
...
echo -e "\n${BOLD_GREEN}Download & install of Elk SUSHI (macOS ARM64) completed successfully!${RESET}\n"